...
$PYTHON_CMD -m pip install -r requirements_zeroShot.txt
...
for emotion in "${emotions[@]}"; do
    ...
    $PYTHON_CMD zeroShot_generation.py "$@" --emotion "$emotion" --output_dir "$OUTPUT_DIR"
done

# Crea archivio ZIP
ZIP_FILE="zeroShot_outputs.zip"
